...
export const colorTokenMap: { [tokenName: string]: { hex: string; description?: string } } = {
  ...
  'betGreen': { hex: '#97c43c', description: 'BetOnline success green (betGreen/500)' },
  ...
  'betGreen/500': { hex: '#97c43c', description: 'BetOnline green primary' },
  ...
  'secondary/main': { hex: '#97c43c', description: 'BetOnline secondary main color (green)' },
  ...
  'secondary/outlinedBorder': { hex: '#97c43c80', description: 'BetOnline secondary outlined border (50% opacity)' },
  'Terciary/outlinedBorder': { hex: '#104e6280', description: 'BetOnline tertiary outlined border (50% opacity)' },
  'secondary/focusVisible': { hex: '#97c43c4d', description: 'BetOnline secondary focus visible (30% opacity)' },
  ...
  'secondary/hover': { hex: '#97c43c0a', description: 'BetOnline secondary hover state (4% opacity)' },
