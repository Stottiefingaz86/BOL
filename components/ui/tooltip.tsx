...
const TooltipContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof TooltipPrimitive.Content> & {
    /** Portals above overflow:hidden ancestors. Avoid inside Vaul drawers. */
    portal?: boolean
  }
>(({ className, sideOffset = 4, portal = false, ...props }, ref) => {
  ...
  // No Portal by default — Vaul/Dialog marks body siblings aria-hidden,
  // which hides portaled tooltips opened from inside drawers.
  return content
})
